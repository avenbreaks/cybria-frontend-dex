    ...
    switch (step) {
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get ZFAI-BNB LP Tokens')}
            </Heading>
            <Text color="textSubtle" small>
              {t('Stake ZFAI and BNB in the liquidity pool to get LP tokens.')} <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent ZFAI-BNB LP tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
