...
import { Card, CardBody, Text, WaitIcon } from '@zaigar-finance/uikit'
...
const SoonRoundCard: React.FC<SoonRoundCardProps> = ({ round }) => {
  ...
  const { secondsRemaining } = useCountdown(round.startTimestamp + useGetIntervalSeconds() + ROUND_BUFFER - 3550)
