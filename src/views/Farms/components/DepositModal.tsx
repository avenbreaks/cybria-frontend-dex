...
import { Flex, Text, Button, Modal, LinkExternal, CalculateIcon, IconButton } from '@zaigar-finance/uikit'
...
const DepositModal: React.FC<DepositModalProps> = ({
  ...
  return (
    <Modal title={isTokenOnly ? t('Stake tokens') : t('Stake tokens')} onDismiss={onDismiss}>
      <ModalInput
        value={val}
