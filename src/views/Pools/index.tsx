...
import { Heading, Flex, Image, Text } from '@zaigar-finance/uikit'
...
const Pools: React.FC = () => {
  ...
  const {
    userData: { zfaiAtLastUserAction, userShares },
    fees: { performanceFee },
    pricePerFullShare,
    totalCakeInVault,
  } = useCakeVault()
      ...
      <PageHeader>
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            ...
            <Heading scale="md" color="text">
              {t('High APR, low risk (Auto Compound on ZFAI Vault available).')}
            </Heading>
          </Flex>
